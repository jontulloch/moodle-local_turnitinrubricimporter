...
/**
 * Renders the "Import from Turnitin or CSV" button for the grading form interface.
 *
...
namespace local_turnitinrubricimporter\output;
...
class renderer extends plugin_renderer_base {
    ...
    /**
     * Renders a button to initiate rubric import from a Turnitin RBC file.
     *
    ...
    public function gradingform_new_form_from_file_button(int $areaid, int $contextid, string $returnurl = ''): string {
        ...
        return $this->output->single_button(
            $url,
            get_string('importfromfile', 'local_turnitinrubricimporter'),
            'get'
        );
    }
}
